  ...
  USERS: [
    {
      ...
      id: "oZc2K6ELpmrL0AcJ6TmTE7HNS-mk",
      // 你想对他发送的模板消息的模板ID
      useTemplateId: "HwRcQovzQSm2Br3xZ1tT3jKUM6U0b58hz4_iIqIpLic",
      // 所在省份
      province: "上海",
      // 所在城市
      city: "上海",
      ...
      openUrl: "https://weibo.com/1743023794?refer_flag=1001030103_",
      // 专属节日提醒，如果你在这里填写了节日提醒，就不会执行FESTIVALS的提醒了, 和FESTIVALS的配置方法相同，可以往下查看，我这里就不重复写了
      festivals: [
        // 注意：此条配置日期为阴历日期，因为`type`中 “生日” 之前有 * 符号
        {"type": "*生日", "name": "盼宝宝", "year": "1992", "date": "02-20"},
      ...
      customizedDateList: [
        // 在一起的日子
        {"keyword": "love_day", date: "2022-01-20"},
        // 结婚纪念日
    ...
    },
    {
      ...
      id: "oZc2K6ELpmrL0AcJ6TmTE7HNS-mk",
      // 你想对他发送的模板消息的模板ID
      useTemplateId: "oZc2K6KQ4rjSu_eff3BI_8n0FG-I",
      // 所在省份
      province: "上海",
      // 所在城市
      city: "上海",
